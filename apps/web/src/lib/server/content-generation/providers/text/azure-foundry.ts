...
function buildPrompt(input: {
  ...
  return [
    ...
    "- Only mark an item as eligible (imageEligibility.eligible: true) if it is a highly concrete, physical, single object, animal, food, tool, or visible location (e.g., 'microscope', 'astronaut', 'castle', 'apple').",
    "- Mark as INELIGIBLE (imageEligibility.eligible: false) any abstract nouns (e.g. 'theory', 'aspect'), verbs (e.g. 'ponder', 'realize'), adverbs, and ALL adjectives (including 'feminine', 'redundant', 'temporary', 'logical').",
    "- Do NOT mark phrasal verbs, idioms, or slang as eligible under any circumstances.",
    "- Default to FALSE. If a word is not a highly concrete physical noun or object where a visual cue is directly helpful, it must be marked as ineligible.",
