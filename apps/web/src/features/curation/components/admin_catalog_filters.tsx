    ...
    <Card className="gap-0 rounded-2xl border bg-card/60 py-0 shadow-sm">
      ...
      <CardContent className="grid gap-5 py-5 lg:grid-cols-2">
        <div className="flex flex-col gap-2">
          ...
          <div className="inline-flex w-full flex-wrap items-center gap-1 rounded-2xl border bg-muted/50 p-1 shadow-sm">
            {typeOptions.map((opt) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "inline-flex min-h-10 flex-1 items-center justify-center gap-2 rounded-xl px-4 py-2 text-sm font-medium transition-all",
                    isActive
